<?php
	Class F1 {
		...
		public function requestData($data, $target){
			...
			switch($target){
				case "f1110" : $resultList = $this->getListLembagaan($data); break;
				case "f11101": $resultList = $this->getListAllLembagaan($data); break;
				case "f1111" : $resultList = $this->getDetailLembagaan($data); break;
				case "f1112" : $resultList = $this->getFetchLembagaan($data); break;
				case "f1113" : $resultList = $this->legalitasByNoreg($data); break;
				case "f1114" : $resultList = $this->legalitasByBentukLembaga($data); break;
				case "f117"  : $resultList = $this->getKoleksiSection($data); break;
				case "f119"  : $resultList = $this->getPrestasiSection($data); break;
				case "f141"  : $resultList = $this->getKoleksi($data); break;
				case "f151"  : $resultList = $this->getVerifikasi($data); break;
		...
		public function getListLembagaan($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function sessionFecth($module){
			$res = array();
			$res = (isset($_SESSION['accessList']) ? $_SESSION['accessList'] : array());
		...
		public function getListAllLembagaan($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getDetailLembagaan($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
			...
			if($gate){		
				...
				if(isset($_SESSION["userLevel"]) && $_SESSION["userLevel"] == '1'){
					...
					/*session fetch*/
					$access1  = $this->sessionFecth('kelembagaan');
					$access2  = $this->sessionFecth('verifikasi');
					$options = array();

					if(!empty($access1) && isset($_SESSION['userLevel'])){
						if($access1['lihat']  == '1' || $_SESSION['userLevel'] == '7') array_push($options, array("selector" => "view-card", "icon" => "search", "label" => "Lihat selengkapnya"));
						// if($access1['lihat']  == '1') array_push($options, array("selector" => "download-card", "icon" => "download", "label" => "Unduh (.pdf)"));
					}

					if(!empty($access2) && isset($_SESSION['userLevel'])){
						if($access2['tambah'] == '1' || $access2['ubah']   == '1' || $_SESSION['userLevel'] == '7') array_push($options, array("selector" => "verification-card", "icon" => "check", "label" => "Verifikasi"));
					}
		...
		public function getFetchLembagaan($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getVerifikasi($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getKoleksiSection($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getPrestasiSection($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getKoleksi($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createKelembagaanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		// LEGLITAS =============
		public function createLegalitasSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function legalitasByNoreg($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function legalitasByBentukLembaga($data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		//SEJARAH ===========================
		public function createSejarahBantuanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeKelembagaanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createSejarahSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeSejarahSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeSaranaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeVisualisasiUsahaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function transferLembaga($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeStatusVerifikasiLegalitas($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeStatusVerifikasiVerifikasi($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function moveLembaga($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createSaranaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createKepengurusanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeKepengurusanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createKegiatanUsahaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function changeKegiatanUsahaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createVisualisasiUsahaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createKoleksiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteKelembagaan($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteSaranaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteVisualisasiUsahaSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteKoleksiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function getLegalitasSection(){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createPrestasiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createHirarkiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function createCatatanVerifikasi($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deletePrestasiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteLegalitasSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteSejarahBantuanSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
		...
		public function deleteHirarkiSection($target, $data){
			/* initial condition */
			$resultList = array();
			$table 		= "";
			$field 		= array();
