...
--
-- Host: localhost
-- Generation Time: Oct 25, 2017 at 07:46 PM
...
--
-- Database: `db_dplegayanbangsos`
--

-- --------------------------------------------------------

--
-- Table structure for table `dplega_000_lembaga`
--

CREATE TABLE `dplega_000_lembaga` (
...
--
-- Dumping data for table `dplega_000_lembaga`
--
...
--
-- Table structure for table `dplega_001_sejarah`
--

CREATE TABLE `dplega_001_sejarah` (
...
--
-- Dumping data for table `dplega_001_sejarah`
--
...
--
-- Table structure for table `dplega_001_sejarah_temp`
--

CREATE TABLE `dplega_001_sejarah_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `deskripsi` text,
  `tanggalDidirikan` date DEFAULT NULL,
...
--
-- Table structure for table `dplega_002_kepengurusan`
--

CREATE TABLE `dplega_002_kepengurusan` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Dumping data for table `dplega_002_kepengurusan`
--
...
--
-- Table structure for table `dplega_002_kepengurusan_temp`
--

CREATE TABLE `dplega_002_kepengurusan_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `penanggungJawab` varchar(100) DEFAULT NULL,
  `jabatan` varchar(20) DEFAULT NULL,
...
--
-- Table structure for table `dplega_003_usaha`
--

CREATE TABLE `dplega_003_usaha` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_003_usaha_temp`
--

CREATE TABLE `dplega_003_usaha_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `namaUsaha` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `dplega_005_koleksi`
--

CREATE TABLE `dplega_005_koleksi` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Dumping data for table `dplega_005_koleksi`
--
...
--
-- Table structure for table `dplega_005_koleksi_temp`
--

CREATE TABLE `dplega_005_koleksi_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `jenisKoleksi` varchar(15) NOT NULL COMMENT 'BUKU/KITAB',
  `judulKoleksi` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `dplega_006_prestasi`
--

CREATE TABLE `dplega_006_prestasi` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Dumping data for table `dplega_006_prestasi`
--
...
--
-- Table structure for table `dplega_006_prestasi_temp`
--

CREATE TABLE `dplega_006_prestasi_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `deskripsi` text NOT NULL,
  `createdBy` varchar(20) NOT NULL,
...
--
-- Table structure for table `dplega_007_visualisasiusaha`
--

CREATE TABLE `dplega_007_visualisasiusaha` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_007_visualisasiusaha_temp`
--

CREATE TABLE `dplega_007_visualisasiusaha_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `urlGambar` varchar(40) NOT NULL,
  `deskripsi` text NOT NULL,
...
--
-- Table structure for table `dplega_008_visualisasisarana`
--

CREATE TABLE `dplega_008_visualisasisarana` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `urlGambar` varchar(40) NOT NULL,
  `deskripsi` text NOT NULL,
...
--
-- Dumping data for table `dplega_008_visualisasisarana`
--
...
--
-- Table structure for table `dplega_008_visualisasisarana_temp`
--

CREATE TABLE `dplega_008_visualisasisarana_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `urlGambar` varchar(40) NOT NULL,
  `deskripsi` text NOT NULL,
...
--
-- Table structure for table `dplega_009_legalitas`
--

CREATE TABLE `dplega_009_legalitas` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Dumping data for table `dplega_009_legalitas`
--
...
(1, '32211200001', '1', 'C-108.HT.03.01.TH.20', '2017-10-09', '32211200001_1_legalitas.jpg', '1', '32211200001testlemb', '2017-10-02 09:00:02', 'admin', '2017-10-02 10:41:52'),
...
--
-- Table structure for table `dplega_009_legalitas_temp`
--

CREATE TABLE `dplega_009_legalitas_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `kodePersyaratan` char(5) NOT NULL,
  `noLegalitas` varchar(20) NOT NULL,
...
--
-- Table structure for table `dplega_010_riwayatbantuan`
--

CREATE TABLE `dplega_010_riwayatbantuan` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Dumping data for table `dplega_010_riwayatbantuan`
--
...
--
-- Table structure for table `dplega_010_riwayatbantuan_temp`
--

CREATE TABLE `dplega_010_riwayatbantuan_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `tahun` char(4) NOT NULL,
  `dibantuOleh` varchar(100) NOT NULL,
...
--
-- Table structure for table `dplega_011_hirarkilembaga`
--

CREATE TABLE `dplega_011_hirarkilembaga` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_011_hirarkilembaga_temp`
--

CREATE TABLE `dplega_011_hirarkilembaga_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `hirarki` char(1) NOT NULL COMMENT '0: parent; 1: child',
  `noRegistrasiTarget` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_012_verifikasi`
--

CREATE TABLE `dplega_012_verifikasi` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_012_verifikasi_temp`
--

CREATE TABLE `dplega_012_verifikasi_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `kodeVerifikasi` int(11) NOT NULL,
  `status` char(1) NOT NULL DEFAULT '0' COMMENT '0: belum, 1: sudah, 2:ubah, 3: salah',
...
--
-- Table structure for table `dplega_013_verifikasilogs`
--

CREATE TABLE `dplega_013_verifikasilogs` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
...
--
-- Table structure for table `dplega_013_verifikasilogs_temp`
--

CREATE TABLE `dplega_013_verifikasilogs_temp` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `kode` int(11) NOT NULL,
  `type` char(1) NOT NULL COMMENT '0: legalitas, 1: lainnya',
...
--
-- Table structure for table `dplega_100_provinsi`
--

CREATE TABLE `dplega_100_provinsi` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_100_provinsi`
--
...
--
-- Table structure for table `dplega_101_wilayah`
--

CREATE TABLE `dplega_101_wilayah` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_101_wilayah`
--
...
--
-- Table structure for table `dplega_102_kecamatan`
--

CREATE TABLE `dplega_102_kecamatan` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_102_kecamatan`
--
...
--
-- Table structure for table `dplega_103_kelurahan`
--

CREATE TABLE `dplega_103_kelurahan` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_103_kelurahan`
--
...
--
-- Table structure for table `dplega_200_bentuklembaga`
--

CREATE TABLE `dplega_200_bentuklembaga` (
  `kodeBentukLembaga` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_200_bentuklembaga`
--
...
--
-- Table structure for table `dplega_201_persyaratan`
--

CREATE TABLE `dplega_201_persyaratan` (
...
--
-- Dumping data for table `dplega_201_persyaratan`
--
...
--
-- Table structure for table `dplega_210_bidanggerak`
--

CREATE TABLE `dplega_210_bidanggerak` (
...
--
-- Dumping data for table `dplega_210_bidanggerak`
--
...
--
-- Table structure for table `dplega_220_grupverifikasi`
--

CREATE TABLE `dplega_220_grupverifikasi` (
...
--
-- Table structure for table `dplega_221_verifikasi`
--

CREATE TABLE `dplega_221_verifikasi` (
  `kodeVerifikasi` int(11) NOT NULL,
...
--
-- Table structure for table `dplega_230_berita`
--

CREATE TABLE `dplega_230_berita` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_230_berita`
--
...
--
-- Table structure for table `dplega_900_logactivities`
--

CREATE TABLE `dplega_900_logactivities` (
  `idData` int(11) NOT NULL,
...
--
-- Table structure for table `dplega_900_logactivities_temp`
--

CREATE TABLE `dplega_900_logactivities_temp` (
  `idData` int(11) NOT NULL,
  `activity` text NOT NULL,
  `status` varchar(7) NOT NULL COMMENT 'SUCCESS/FAILED/PENDING',
  `message` text NOT NULL,
...
--
-- Table structure for table `dplega_901_notifications`
--

CREATE TABLE `dplega_901_notifications` (
  `idData` int(11) NOT NULL,
  `deskripsi` text NOT NULL,
...
--
-- Dumping data for table `dplega_901_notifications`
--
...
--
-- Table structure for table `dplega_910_user`
--

CREATE TABLE `dplega_910_user` (
  `idData` int(11) NOT NULL,
  `noRegistrasi` char(11) NOT NULL,
  `nama` varchar(100) NOT NULL,
...
--
-- Dumping data for table `dplega_910_user`
--
...
(75, '32211200001', 'Test Lembaga', 'Penanggung jawab Lembaga', 'Jl. Cibangkong 51A/120', '004', '012', 63, 16, 27, 8, '085794867714', 'megareceiver@gmail.com', '32211200001testlemb', '098f6bcd4621d373cade4e832627b4f6', '32211200001_logo.png', 1, '', 0, 1, 'admin', '2017-10-02 00:42:57', '32211200001testlemb', '2017-10-02 08:54:40'),
...
--
-- Table structure for table `dplega_911_useraccess`
--

CREATE TABLE `dplega_911_useraccess` (
  `idData` int(11) NOT NULL,
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `dplega_911_useraccess`
--
...
(120, '32211200001testlemb', 1, 'kelembagaan', '1', '0', '1', '0', 1, 'TESTSESSION', '2017-10-02 00:42:57', NULL, NULL),
...
--
-- Table structure for table `dplega_912_apps`
--

CREATE TABLE `dplega_912_apps` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_912_apps`
--
...
--
-- Table structure for table `dplega_920_backuphistory`
--

CREATE TABLE `dplega_920_backuphistory` (
  `idData` int(11) NOT NULL,
...
--
-- Dumping data for table `dplega_920_backuphistory`
--
...
--
-- Table structure for table `dplega_921_restorehistory`
--

CREATE TABLE `dplega_921_restorehistory` (
  `idData` int(11) NOT NULL,
  `namaFile` varchar(100) NOT NULL,
  `createdBy` varchar(20) NOT NULL,
  `createdDate` datetime NOT NULL,
...
ALTER TABLE `dplega_221_verifikasi`
  ...
  ADD KEY `kodeGrupVerifikasi` (`kodeGrupVerifikasi`);
